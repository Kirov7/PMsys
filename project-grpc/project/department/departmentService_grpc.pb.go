...
type DepartmentServiceClient interface {
	Save(ctx context.Context, in *DepartmentRequest, opts ...grpc.CallOption) (*DepartmentMessage, error)
	Read(ctx context.Context, in *DepartmentRequest, opts ...grpc.CallOption) (*DepartmentMessage, error)
	List(ctx context.Context, in *DepartmentRequest, opts ...grpc.CallOption) (*ListDepartmentMessage, error)
}
...
func (c *departmentServiceClient) Save(ctx context.Context, in *DepartmentRequest, opts ...grpc.CallOption) (*DepartmentMessage, error) {
...
func (c *departmentServiceClient) Read(ctx context.Context, in *DepartmentRequest, opts ...grpc.CallOption) (*DepartmentMessage, error) {
	out := new(DepartmentMessage)
...
func (c *departmentServiceClient) List(ctx context.Context, in *DepartmentRequest, opts ...grpc.CallOption) (*ListDepartmentMessage, error) {
...
type DepartmentServiceServer interface {
	Save(context.Context, *DepartmentRequest) (*DepartmentMessage, error)
	Read(context.Context, *DepartmentRequest) (*DepartmentMessage, error)
	List(context.Context, *DepartmentRequest) (*ListDepartmentMessage, error)
...
func (UnimplementedDepartmentServiceServer) Save(context.Context, *DepartmentRequest) (*DepartmentMessage, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Save not implemented")
}
func (UnimplementedDepartmentServiceServer) Read(context.Context, *DepartmentRequest) (*DepartmentMessage, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Read not implemented")
}
func (UnimplementedDepartmentServiceServer) List(context.Context, *DepartmentRequest) (*ListDepartmentMessage, error) {
...
func _DepartmentService_Save_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DepartmentServiceServer).Save(ctx, req.(*DepartmentRequest))
	}
...
func _DepartmentService_Read_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DepartmentServiceServer).Read(ctx, req.(*DepartmentRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _DepartmentService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DepartmentServiceServer).List(ctx, req.(*DepartmentRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DepartmentService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "departmentService.proto",
}
