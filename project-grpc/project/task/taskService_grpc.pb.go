...
type TaskServiceClient interface {
	...
	CreateComment(ctx context.Context, in *TaskRequest, opts ...grpc.CallOption) (*CreateCommentResponse, error)
}
...
func (c *taskServiceClient) CreateComment(ctx context.Context, in *TaskRequest, opts ...grpc.CallOption) (*CreateCommentResponse, error) {
...
type TaskServiceServer interface {
	...
	CreateComment(context.Context, *TaskRequest) (*CreateCommentResponse, error)
...
func (UnimplementedTaskServiceServer) CreateComment(context.Context, *TaskRequest) (*CreateCommentResponse, error) {
...
func _TaskService_CreateComment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TaskServiceServer).CreateComment(ctx, req.(*TaskRequest))
	}
	return interceptor(ctx, in, info, handler)
}
