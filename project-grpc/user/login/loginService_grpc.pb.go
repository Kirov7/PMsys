...
type LoginServiceClient interface {
	...
	OrgList(ctx context.Context, in *OrgListRequest, opts ...grpc.CallOption) (*OrgListResponse, error)
	FindMemInfoById(ctx context.Context, in *MemIdRequest, opts ...grpc.CallOption) (*MemberMessage, error)
	FindMemInfoByIds(ctx context.Context, in *MemIdRequest, opts ...grpc.CallOption) (*MemberMessageList, error)
}
...
func (c *loginServiceClient) OrgList(ctx context.Context, in *OrgListRequest, opts ...grpc.CallOption) (*OrgListResponse, error) {
	out := new(OrgListResponse)
	err := c.cc.Invoke(ctx, "/login.LoginService/OrgList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *loginServiceClient) FindMemInfoById(ctx context.Context, in *MemIdRequest, opts ...grpc.CallOption) (*MemberMessage, error) {
...
func (c *loginServiceClient) FindMemInfoByIds(ctx context.Context, in *MemIdRequest, opts ...grpc.CallOption) (*MemberMessageList, error) {
...
type LoginServiceServer interface {
	...
	OrgList(context.Context, *OrgListRequest) (*OrgListResponse, error)
	FindMemInfoById(context.Context, *MemIdRequest) (*MemberMessage, error)
	FindMemInfoByIds(context.Context, *MemIdRequest) (*MemberMessageList, error)
...
func (UnimplementedLoginServiceServer) OrgList(context.Context, *OrgListRequest) (*OrgListResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method OrgList not implemented")
}
func (UnimplementedLoginServiceServer) FindMemInfoById(context.Context, *MemIdRequest) (*MemberMessage, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FindMemInfoById not implemented")
}
func (UnimplementedLoginServiceServer) FindMemInfoByIds(context.Context, *MemIdRequest) (*MemberMessageList, error) {
...
func _LoginService_OrgList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(OrgListRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LoginServiceServer).OrgList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/login.LoginService/OrgList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LoginServiceServer).OrgList(ctx, req.(*OrgListRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _LoginService_FindMemInfoById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LoginServiceServer).FindMemInfoById(ctx, req.(*MemIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _LoginService_FindMemInfoByIds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LoginServiceServer).FindMemInfoByIds(ctx, req.(*MemIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var LoginService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "OrgList",
			Handler:    _LoginService_OrgList_Handler,
		},
		{
