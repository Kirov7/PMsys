...
type MenuServiceClient interface {
	MenuList(ctx context.Context, in *MenuRequest, opts ...grpc.CallOption) (*MenuListResponse, error)
}
...
func (c *menuServiceClient) MenuList(ctx context.Context, in *MenuRequest, opts ...grpc.CallOption) (*MenuListResponse, error) {
...
type MenuServiceServer interface {
	MenuList(context.Context, *MenuRequest) (*MenuListResponse, error)
...
func (UnimplementedMenuServiceServer) MenuList(context.Context, *MenuRequest) (*MenuListResponse, error) {
...
func _MenuService_MenuList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MenuServiceServer).MenuList(ctx, req.(*MenuRequest))
	}
